...
function preload()
{
	//boyImg = loadImage("Plucking+mangoes/Pluckingmangoes/boy.png");
	treeImg = loadImage("Plucking+mangoes/Sprites/Plucking mangoes/tree.png");
 boyImg = loadImage("Plucking+mangoes/Sprites/Plucking mangoes/boy.png");
...
function setup() {
	...
	string = new Sling(stone.body,{x:145, y:470});
